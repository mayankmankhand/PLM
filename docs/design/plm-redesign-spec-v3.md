...
**Audience:** Mayank, sole developer. Smartwatch PLM tool with AI chat + context panel.
...
- Example chips: "Show all requirements", "What's untested?", "GPS traceability diagram", "Recent audit log".
