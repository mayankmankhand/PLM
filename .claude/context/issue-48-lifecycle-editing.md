# Issue #48: No Way to Edit DRAFT or Fix Approved Typos
...
2. **Undo mistakes** (Issue #49) - restore attachments, correct test results, un-skip, re-run failed tests
3. **Structural changes** (Issue #50) - re-parent entities, reactivate canceled trees
...
## Related Issues
- Issue #49: Undo mistakes (restore, correct, re-run) - priority-high improvement
- Issue #50: Structural changes (re-parent and reactivate) - priority-high improvement
